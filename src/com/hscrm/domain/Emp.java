...
public class Emp {
    ...
    public Emp(int e_id, String e_name, String e_sex, String e_tel, String username) {
        this.e_id = e_id;
        this.e_name = e_name;
        this.e_sex = e_sex;
        this.e_tel = e_tel;
    ...
    public Emp(String e_name, String e_sex, String e_tel, String username, String passwd) {
        this.e_name = e_name;
        this.e_sex = e_sex;
        this.e_tel = e_tel;
        this.username = username;
